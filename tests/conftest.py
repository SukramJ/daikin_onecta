...
async def snapshot_platform_entities(
    ...
    for entity_entry in entity_entries:
        entity_entry == snapshot(name=f"{entity_entry.entity_id}-entry")  # noqa: B015  # TODO Phase 8: add assert back
        hass.states.get(entity_entry.entity_id) == snapshot(name=f"{entity_entry.entity_id}-state")  # noqa: B015  # TODO Phase 8: add assert back
